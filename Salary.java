public class Salary {
    ...
    public static void main(String[] args) {
        Employee employee1 = new Employee("George",100,2,2019);
        Accounting accounting = new Accounting(employee1);
        //accounting.getTotalSalary(employee1);
        accounting.toString1(employee1);
